...
public class MentorshipsInternships3 extends AppCompatActivity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Reusable reuse = new Reusable(MentorshipsInternships3.this, AdultWorkAndCareerProgram1.class);
        reuse.setup();

        text getContent = new text();
        String volunteer = getContent.getMentorshipsInternship3();
