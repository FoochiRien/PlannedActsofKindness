...
public class KarmicConstitution extends AppCompatActivity{
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.test_without_g);

        Reusable reuse = new Reusable(KarmicConstitution.this, Volunteer.class);
        reuse.setup();

        text getContent = new text();
        String volunteer = getContent.getKarmicConstitution();
