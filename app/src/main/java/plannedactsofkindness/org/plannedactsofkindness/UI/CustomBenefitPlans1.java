...
public class CustomBenefitPlans1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Reusable reuse = new Reusable(CustomBenefitPlans1.this, CustomBenefitPlans2.class);
        reuse.setup();

        text getContent = new text();
        String volunteer = getContent.getCustomBenefitPlans1();
