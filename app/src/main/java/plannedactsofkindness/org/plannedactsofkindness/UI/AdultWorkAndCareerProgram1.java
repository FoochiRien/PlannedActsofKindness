...
public class AdultWorkAndCareerProgram1  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Reusable reuse = new Reusable(AdultWorkAndCareerProgram1.this, AdultWorkAndCareerProgram2.class);
        reuse.setup();

        text getContent = new text();
        String volunteer = getContent.getAdultWorkAndCareer1();
