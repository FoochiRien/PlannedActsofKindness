...
public class AdultWorkAndCareerProgram2  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Reusable reuse = new Reusable(AdultWorkAndCareerProgram2.this, ThinkYouHaveWhatItTakes.class);
        reuse.setup();

        text getContent = new text();
        String volunteer = getContent.getAdultWorkAndCareer2();
